...
public class MessageTrait {
	...
	public String toString() {
		return "MessageTrait [headers=" + this.headers + ", correlationId=" + this.correlationId + ", schemaFormat=" + this.schemaFormat + ", contentType=" + this.contentType + ", name=" + this.name + ", title=" + this.title + ", summary=" + this.summary + ", description=" + this.description + ", tags=" + this.tags + ", externalDocs="
