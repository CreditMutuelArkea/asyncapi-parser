...
public class Operation {
	...
	private String operationId	= null; //string	Unique string used to identify the operation. The id MUST be unique among all operations described in the API. The operationId value is case-sensitive. Tools and libraries MAY use the operationId to uniquely identify an operation, therefore, it is RECOMMENDED to follow common programming naming conventions.
	...
	private List<Message> message	= null; //	[Message Object | Reference Object]	A definition of the message that will be published or received on this channel. oneOf is allowed here to specify multiple messages, however, a message MUST be valid only against one of the referenced message objects.
	...
	public String toString() {
		return "Operation [operationId=" + this.operationId + ", summary=" + this.summary + ", description=" + this.description + ", tags=" + this.tags + ", externalDocs=" + this.externalDocs + ", bindings=" + this.bindings + ", traits=" + this.traits + ", message=" + this.message + ", extensions=" + this.extensions + "]";
	}
