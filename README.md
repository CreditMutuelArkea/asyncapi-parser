...
This is a java implementation (parser and models) for AsyncApi. Part of this content and code structure has been taken from the great work done by the folks at the [OpenAPI Initiative](https://openapis.org). Mainly because **it's a great work** and because we want to keep it closer as possible on the [OpenAPI Community](https://github.com/OAI/).

#### Trademarks
 
Copyright 2020 Credit Mutuel Arkea

This work has been coded by Cedric Nouris and reviewed by Goulven Furet.
